...
-- Fecha: 2025-12-15
-- Nota: Estos datos se cargarán automáticamente en H2 (desarrollo)
...
(1, 'Viaje a París', 'París, Francia', 'Fin de semana con amigos explorando la ciudad de la luz', '2025-06-01', '2025-06-05', 2000.00, 'PARIS2025'),
(2, 'Barcelona Week', 'Barcelona, España', 'Una semana completa en la capital de Cataluña', '2025-07-15', '2025-07-22', 3500.00, 'BCN07WEEK'),
(3, 'Tokyo Adventure', 'Tokio, Japón', 'Viaje épico a Japón durante dos semanas', '2025-08-10', '2025-08-25', 5000.00, 'TOKYO2025');
...
-- Gasto 6: €1200.00 dividido en 2 = €600.00 cada uno
INSERT INTO expense_splits (id, expense_id, participant_user_id, amount, percentage, paid) VALUES
(14, 6, 1, 600.00, 50.00, TRUE),
(15, 6, 3, 600.00, 50.00, FALSE);
